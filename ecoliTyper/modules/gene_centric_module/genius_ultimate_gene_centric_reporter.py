...
- Dynamic grouping of genome lists by MLST, serotype, phylogroup, CH type,
  and expanded combinations: pairwise (ST+Serotype, ST+CHtype, Serotype+Phylogroup,
  Serotype+CHtype, Phylogroup+CHtype), triple (ST+Serotype+Phylogroup,
  ST+Serotype+CHtype, ST+Phylogroup+CHtype), and four-way (ST+Serotype+Phylogroup+CHtype)
...
Credits:
To all the giants we stand on and occassionally sit on their shoulders!!
...
class UltimateHTMLGenerator:
    ...
    def generate_main_report(self, integrated_data: Dict[str, Any], output_dir: Path) -> str:
        ...
        output_file = output_dir / "genius_ecoli_ultimate_gene_centric_report.html"
    ...
    def _create_ultimate_html(self, **kwargs) -> str:
        ...
        The JavaScript getTypingValue function supports all pairwise, triple, and full (all four) grouping combinations.
        """
    ...
    <div class="metadata-item"><i class="fas fa-user-md"></i> GENIUS Ultimate v3.2.0</div>
    ...
    def _qc_section(self, kwargs):
        """
        Generate the FASTA Quality Control tab with assembly metrics.
        Includes a tool credit bar acknowledging Biopython and FastANI.
        """
    ...
    def _mlst_section(self, kwargs):
        """
        Generate the MLST tab with ST distribution and all combination tables.
        Includes a tool credit bar acknowledging PubMLST and Torsten Seemann.
        """
        patterns = kwargs['patterns']
    ...
    def _serotype_section(self, kwargs):
        """
        Generate the Serotype (O:H) tab with distribution tables and genome tags.
        Includes a tool credit bar acknowledging CGE SerotypeFinder and Joensen et al. (2015).
        """
        patterns = kwargs['patterns']
    ...
    def _chtype_section(self, kwargs):
        """
        Generate the CH Type (FumC:FimH) tab with distribution tables and genome tags.
        Includes a tool credit bar acknowledging CGE CHTyper, Henrik Hasman, and Roer et al. (2018).
        """
        patterns = kwargs['patterns']
    ...
    def _phylogroup_section(self, kwargs):
        """
        Generate the Phylogroup (Clermont scheme) tab with distribution tables and genome tags.
        Includes a tool credit bar acknowledging EzClermont and Clermont et al. (2013).
        """
        patterns = kwargs['patterns']
    ...
    def _amr_section(self, kwargs):
        """
        Generate the AMR gene tab with gene-centric table, filtering, and grouping.
        Includes a tool credit bar acknowledging NCBI AMRFinderPlus, ABRicate, and the resistance databases.
        """
        gene_centric = kwargs['gene_centric']
        all_genes = []
        ...
        html = """
        <div class="scientific-note" style="background: linear-gradient(135deg, #f8f9fa 0%, #fce4ec 100%); border-left: 6px solid #F44336; margin-bottom: 20px;">
            <div style="display: flex; align-items: center; gap: 12px; flex-wrap: wrap;">
                <span style="font-size: 1.4em;">🧬</span>
                <div>
                    <strong style="font-size: 1.2em; color: #b71c1c;">AMR Detection – Acknowledgements</strong><br>
                    <span style="font-size: 0.95em; color: #333;">
                        Powered by 
                        <a href="https://github.com/ncbi/amr" target="_blank" style="color: #dc3545; font-weight: bold;">NCBI AMRFinderPlus</a> 
                        for resistance gene and point mutation detection, and 
                        <a href="https://github.com/tseemann/abricate" target="_blank" style="color: #dc3545; font-weight: bold;">ABRicate</a> 
                        (Prof. Torsten Seemann) for database screening.<br>
                        Databases used: 
                        ...
                        <span style="font-size: 0.9em; color: #6c757d;">
                            <i class="fas fa-gratipay"></i> We thank all developers and curators for their open‑source contributions.
                        </span>
                    </span>
                </div>
            </div>
        ...
        <div class="grouping-controls">
            ...
            <button class="group-btn" data-group="CHtype" onclick="groupGenomesByTyping('amr-table','CHtype')">CHtype</button>
            ...
            <button class="group-btn" data-group="ST+CHtype" onclick="groupGenomesByTyping('amr-table','ST+CHtype')">ST+CHtype</button>
            <button class="group-btn" data-group="Serotype+Phylogroup" onclick="groupGenomesByTyping('amr-table','Serotype+Phylogroup')">Serotype+Phylogroup</button>
            <button class="group-btn" data-group="Serotype+CHtype" onclick="groupGenomesByTyping('amr-table','Serotype+CHtype')">Serotype+CHtype</button>
            <button class="group-btn" data-group="Phylogroup+CHtype" onclick="groupGenomesByTyping('amr-table','Phylogroup+CHtype')">Phylogroup+CHtype</button>
            <button class="group-btn" data-group="ST+Serotype+Phylogroup" onclick="groupGenomesByTyping('amr-table','ST+Serotype+Phylogroup')">ST+Serotype+Phylogroup</button>
            <button class="group-btn" data-group="ST+Serotype+CHtype" onclick="groupGenomesByTyping('amr-table','ST+Serotype+CHtype')">ST+Serotype+CHtype</button>
            <button class="group-btn" data-group="ST+Phylogroup+CHtype" onclick="groupGenomesByTyping('amr-table','ST+Phylogroup+CHtype')">ST+Phylogroup+CHtype</button>
            <button class="group-btn" data-group="Full" onclick="groupGenomesByTyping('amr-table','Full')">Full (all four)</button>
    ...
    def _virulence_section(self, kwargs):
        """
        Generate the Virulence gene tab with gene-centric table, filtering, and grouping.
        Includes a tool credit bar acknowledging VFDB and ABRicate.
        """
        gene_centric = kwargs['gene_centric']
        all_genes = []
        ...
        <div class="scientific-note" style="background: linear-gradient(135deg, #f8f9fa 0%, #fce4ec 100%); border-left: 6px solid #E91E63; margin-bottom: 20px;">
            <div style="display: flex; align-items: center; gap: 12px; flex-wrap: wrap;">
                <span style="font-size: 1.4em;">🦠</span>
                <div>
                    <strong style="font-size: 1.2em; color: #880e4f;">Virulence Detection – Acknowledgements</strong><br>
                    <span style="font-size: 0.95em; color: #333;">
                        Powered by 
                        <a href="http://www.mgc.ac.cn/VFs/" target="_blank" style="color: #E91E63; font-weight: bold;">VFDB (Virulence Factor Database)</a> 
                        and screened via 
                        <a href="https://github.com/tseemann/abricate" target="_blank" style="color: #E91E63; font-weight: bold;">ABRicate</a> 
        ...
        <div class="grouping-controls">
            ...
            <button class="group-btn" data-group="CHtype" onclick="groupGenomesByTyping('vir-table','CHtype')">CHtype</button>
            ...
            <button class="group-btn" data-group="ST+CHtype" onclick="groupGenomesByTyping('vir-table','ST+CHtype')">ST+CHtype</button>
            <button class="group-btn" data-group="Serotype+Phylogroup" onclick="groupGenomesByTyping('vir-table','Serotype+Phylogroup')">Serotype+Phylogroup</button>
            <button class="group-btn" data-group="Serotype+CHtype" onclick="groupGenomesByTyping('vir-table','Serotype+CHtype')">Serotype+CHtype</button>
            <button class="group-btn" data-group="Phylogroup+CHtype" onclick="groupGenomesByTyping('vir-table','Phylogroup+CHtype')">Phylogroup+CHtype</button>
            <button class="group-btn" data-group="ST+Serotype+Phylogroup" onclick="groupGenomesByTyping('vir-table','ST+Serotype+Phylogroup')">ST+Serotype+Phylogroup</button>
            <button class="group-btn" data-group="ST+Serotype+CHtype" onclick="groupGenomesByTyping('vir-table','ST+Serotype+CHtype')">ST+Serotype+CHtype</button>
            <button class="group-btn" data-group="ST+Phylogroup+CHtype" onclick="groupGenomesByTyping('vir-table','ST+Phylogroup+CHtype')">ST+Phylogroup+CHtype</button>
            <button class="group-btn" data-group="Full" onclick="groupGenomesByTyping('vir-table','Full')">Full (all four)</button>
    ...
    def _plasmid_section(self, kwargs):
        """
        Generate the Plasmid replicon and serotyping markers tab.
        Includes a tool credit bar acknowledging PlasmidFinder, EcoH, and ABRicate.
        """
        gene_centric = kwargs['gene_centric']
        all_genes = []
        ...
        html = """
        <div class="scientific-note" style="background: linear-gradient(135deg, #f8f9fa 0%, #e8eaf6 100%); border-left: 6px solid #3F51B5; margin-bottom: 20px;">
            <div style="display: flex; align-items: center; gap: 12px; flex-wrap: wrap;">
                <span style="font-size: 1.4em;">🧬</span>
                <div>
                    <strong style="font-size: 1.2em; color: #1a237e;">Plasmid & Serotyping – Acknowledgements</strong><br>
                    <span style="font-size: 0.95em; color: #333;">
                        Powered by 
                        <a href="https://cge.food.dtu.dk/services/PlasmidFinder/" target="_blank" style="color: #3F51B5; font-weight: bold;">PlasmidFinder</a> 
                        (Center for Genomic Epidemiology) and 
                        <a href="https://github.com/djingle/EcoH" target="_blank" style="color: #3F51B5; font-weight: bold;">EcoH</a> 
                        (Ingle et al.), both screened via 
                        <a href="https://github.com/tseemann/abricate" target="_blank" style="color: #3F51B5; font-weight: bold;">ABRicate</a> 
                        (Prof. Torsten Seemann).<br>
                        Please cite:
                        <a href="https://doi.org/10.1128/AAC.02412-14" target="_blank" style="color: #3F51B5; font-weight: bold;">
                            Carattoli A, et al. In silico detection and typing of plasmids using PlasmidFinder. Antimicrob Agents Chemother. 2014;58(7):3895-903.
                        </a>
                        and
                        <a href="https://doi.org/10.1099/mgen.0.000064" target="_blank" style="color: #3F51B5; font-weight: bold;">
                            Ingle DJ, et al. In silico serotyping of E. coli from short read data. Microb Genom. 2016;2(7):e000064.
                        </a>
                        <br>
                        <span style="font-size: 0.9em; color: #6c757d;">
        ...
        <div class="grouping-controls">
            <strong><i class="fas fa-layer-group"></i> Group genomes by:</strong>
            <button class="group-btn" data-group="ST" onclick="groupGenomesByTyping('plasmid-table','ST')">ST</button>
            ...
            <button class="group-btn" data-group="CHtype" onclick="groupGenomesByTyping('plasmid-table','CHtype')">CHtype</button>
            ...
            <button class="group-btn" data-group="ST+CHtype" onclick="groupGenomesByTyping('plasmid-table','ST+CHtype')">ST+CHtype</button>
            <button class="group-btn" data-group="Serotype+Phylogroup" onclick="groupGenomesByTyping('plasmid-table','Serotype+Phylogroup')">Serotype+Phylogroup</button>
            <button class="group-btn" data-group="Serotype+CHtype" onclick="groupGenomesByTyping('plasmid-table','Serotype+CHtype')">Serotype+CHtype</button>
            <button class="group-btn" data-group="Phylogroup+CHtype" onclick="groupGenomesByTyping('plasmid-table','Phylogroup+CHtype')">Phylogroup+CHtype</button>
            <button class="group-btn" data-group="ST+Serotype+Phylogroup" onclick="groupGenomesByTyping('plasmid-table','ST+Serotype+Phylogroup')">ST+Serotype+Phylogroup</button>
            <button class="group-btn" data-group="ST+Serotype+CHtype" onclick="groupGenomesByTyping('plasmid-table','ST+Serotype+CHtype')">ST+Serotype+CHtype</button>
            <button class="group-btn" data-group="ST+Phylogroup+CHtype" onclick="groupGenomesByTyping('plasmid-table','ST+Phylogroup+CHtype')">ST+Phylogroup+CHtype</button>
            <button class="group-btn" data-group="Full" onclick="groupGenomesByTyping('plasmid-table','Full')">Full (all four)</button>
    ...
    def _bacmet_section(self, kwargs):
        """
        Generate the Bacmet (biocide, heavy metal, and stress resistance) tab.
        Includes a tool credit bar acknowledging BacMet and ABRicate.
        """
        gene_centric = kwargs['gene_centric']
        all_genes = []
        ...
        <div class="scientific-note" style="background: linear-gradient(135deg, #f8f9fa 0%, #e0f7fa 100%); border-left: 6px solid #00BCD4; margin-bottom: 20px;">
            <div style="display: flex; align-items: center; gap: 12px; flex-wrap: wrap;">
                <span style="font-size: 1.4em;">🧪</span>
                <div>
                    <strong style="font-size: 1.2em; color: #006064;">BACMET – Acknowledgements</strong><br>
                    <span style="font-size: 0.95em; color: #333;">
                        Powered by the 
                        <a href="https://bacmet.biomedicine.gu.se/" target="_blank" style="color: #00BCD4; font-weight: bold;">BacMet database</a> 
                        (Pal et al.) and screened via 
                        <a href="https://github.com/tseemann/abricate" target="_blank" style="color: #00BCD4; font-weight: bold;">ABRicate</a> 
                        (Prof. Torsten Seemann).<br>
                        Please cite: 
                        <a href="https://doi.org/10.1093/nar/gkt1252" target="_blank" style="color: #00BCD4; font-weight: bold;">
        ...
        <div class="grouping-controls">
            ...
            <button class="group-btn" data-group="CHtype" onclick="groupGenomesByTyping('bac-table','CHtype')">CHtype</button>
            ...
            <button class="group-btn" data-group="ST+CHtype" onclick="groupGenomesByTyping('bac-table','ST+CHtype')">ST+CHtype</button>
            <button class="group-btn" data-group="Serotype+Phylogroup" onclick="groupGenomesByTyping('bac-table','Serotype+Phylogroup')">Serotype+Phylogroup</button>
            <button class="group-btn" data-group="Serotype+CHtype" onclick="groupGenomesByTyping('bac-table','Serotype+CHtype')">Serotype+CHtype</button>
            <button class="group-btn" data-group="Phylogroup+CHtype" onclick="groupGenomesByTyping('bac-table','Phylogroup+CHtype')">Phylogroup+CHtype</button>
            <button class="group-btn" data-group="ST+Serotype+Phylogroup" onclick="groupGenomesByTyping('bac-table','ST+Serotype+Phylogroup')">ST+Serotype+Phylogroup</button>
            <button class="group-btn" data-group="ST+Serotype+CHtype" onclick="groupGenomesByTyping('bac-table','ST+Serotype+CHtype')">ST+Serotype+CHtype</button>
            <button class="group-btn" data-group="ST+Phylogroup+CHtype" onclick="groupGenomesByTyping('bac-table','ST+Phylogroup+CHtype')">ST+Phylogroup+CHtype</button>
            <button class="group-btn" data-group="Full" onclick="groupGenomesByTyping('bac-table','Full')">Full (all four)</button>
    ...
    def _mutation_section(self, kwargs):
        """
        Generate the Point Mutations tab with gene-centric view and grouping.
        Includes a tool credit bar acknowledging NCBI AMRFinderPlus.
        """
        ...
        <div class="scientific-note" style="background: linear-gradient(135deg, #f8f9fa 0%, #e0f7fa 100%); border-left: 6px solid #00BCD4; margin-bottom: 20px;">
            <div style="display: flex; align-items: center; gap: 12px; flex-wrap: wrap;">
                <span style="font-size: 1.4em;">🧬</span>
                <div>
                    <strong style="font-size: 1.2em; color: #006064;">Point Mutations – Acknowledgements</strong><br>
                    <span style="font-size: 0.95em; color: #333;">
                        Point mutations detected by 
                        <a href="https://github.com/ncbi/amr" target="_blank" style="color: #00BCD4; font-weight: bold;">NCBI AMRFinderPlus</a>.<br>
                        Please cite: 
                        <a href="https://doi.org/10.1038/s41598-021-91456-0" target="_blank" style="color: #00BCD4; font-weight: bold;">
                        ...
                        <br>
                        <span style="font-size: 0.9em; color: #6c757d;">
                            <i class="fas fa-gratipay"></i> We thank the NCBI team for maintaining this essential resource.
                        </span>
                    </span>
                </div>
            </div>
        ...
        <div class="grouping-controls">
            <strong><i class="fas fa-layer-group"></i> Group genomes by:</strong>
            <button class="group-btn" data-group="ST" onclick="groupGenomesByTyping('mutation-table','ST')">ST</button>
            ...
            <button class="group-btn" data-group="CHtype" onclick="groupGenomesByTyping('mutation-table','CHtype')">CHtype</button>
            ...
            <button class="group-btn" data-group="ST+CHtype" onclick="groupGenomesByTyping('mutation-table','ST+CHtype')">ST+CHtype</button>
            <button class="group-btn" data-group="Serotype+Phylogroup" onclick="groupGenomesByTyping('mutation-table','Serotype+Phylogroup')">Serotype+Phylogroup</button>
            <button class="group-btn" data-group="Serotype+CHtype" onclick="groupGenomesByTyping('mutation-table','Serotype+CHtype')">Serotype+CHtype</button>
            <button class="group-btn" data-group="Phylogroup+CHtype" onclick="groupGenomesByTyping('mutation-table','Phylogroup+CHtype')">Phylogroup+CHtype</button>
            <button class="group-btn" data-group="ST+Serotype+Phylogroup" onclick="groupGenomesByTyping('mutation-table','ST+Serotype+Phylogroup')">ST+Serotype+Phylogroup</button>
            <button class="group-btn" data-group="ST+Serotype+CHtype" onclick="groupGenomesByTyping('mutation-table','ST+Serotype+CHtype')">ST+Serotype+CHtype</button>
            <button class="group-btn" data-group="ST+Phylogroup+CHtype" onclick="groupGenomesByTyping('mutation-table','ST+Phylogroup+CHtype')">ST+Phylogroup+CHtype</button>
            <button class="group-btn" data-group="Full" onclick="groupGenomesByTyping('mutation-table','Full')">Full (all four)</button>
    ...
    def _export_section(self):
        ...
        <div class="action-buttons">
            ...
            <button class="action-btn btn-success" onclick="location.href='genius_ecoli_ultimate_gene_centric_report.json'">Download JSON</button>
        </div>
        """
...
class GeniusUltimateReporter:
    ...
    def __init__(self, input_dir: Path):
        ...
        self.output_dir = self.input_dir / "GENIUS_ECOLI_ULTIMATE_GENE_CENTRIC_REPORTS"
    ...
    def generate_json_report(self, data: Dict[str, Any]) -> Path:
        ...
        out = self.output_dir / "genius_ecoli_ultimate_gene_centric_report.json"
    ...
    def run(self):
        ...
        print("=" * 80)
        print("🧠 GENIUS E.COLI ULTIMATE REPORTER v3.2.0")
        print("=" * 80)
        ...
        print(f"   • genius_ecoli_ultimate_gene_centric_report.html (Interactive report)")
        print(f"   • genius_ecoli_ultimate_gene_centric_report.json (Complete data)")
        ...
        print("\n🎯 Next steps:")
        print("   1. Open genius_ecoli_ultimate_gene_centric_report.html in your browser")
...
Affiliation: University of Ghana Medical School, Department of Medical Biochemistry
    ...
    parser.add_argument('-o', '--output-dir',
                        help='Custom output directory (default: input_dir/GENIUS_ECOLI_ULTIMATE_GENE_CENTRIC_REPORTS)')
