...
class ECOLITYPER_QC:
    ...
    def _check_ecoli_specific(self, gc_percent: float, gc_contents: List[float],
        ...
        return {
            ...
            'expected_genome_size': "4.5-5.5 Mbp"
        }
    ...
    def create_individual_html_report(self, results: Dict[str, Any], output_dir: str) -> str:
        ...
        html_file = os.path.join(sample_dir, f"{filename_no_ext}_ecolityper_qc_report.html")
...
<script>
    ...
    function exportToJSON() {{
        ...
        json_file = os.path.join(sample_dir, f"{filename_no_ext}_ecolityper_qc_report.json")
    ...
    def process_files(self, pattern: str, output_dir: str = "ecolityper_qc_results") -> List[Dict[str, Any]]:
        ...
        print("\n📁 OUTPUT FILES:")
        print(f"   Individual HTML reports: {output_dir}/*/*_ecolityper_qc_report.html")
        print(f"   Individual JSON reports: {output_dir}/*/*_ecolityper_qc_report.json")
